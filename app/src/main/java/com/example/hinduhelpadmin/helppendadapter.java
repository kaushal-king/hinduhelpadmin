...
public class helppendadapter extends RecyclerView.Adapter<helppendadapter.ViewHolder>{
String id;
    Context mcontext;
    private List<help_get_set> data;
    public helppendadapter(Context mcontext,List<help_get_set> data){
        this.data=data;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemview = LayoutInflater.from(parent.getContext()).inflate(R.layout.pendlayout, null);
        ...
        viewHolder.b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<CommanResponse> call=api.huptwo("helpone",id,"2");
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            id=(TextView) itemView.findViewById(R.id.helppendid);
            name=(TextView) itemView.findViewById(R.id.helppendname);
            date=(TextView) itemView.findViewById(R.id.helppenddate);
